...
plot(pr, vertex.size=1, edge.arrow.size=0.05, edge.curved=.2, vertex.label=NA, layout = layout_with_fr, main="Zitationsnetzwerk PR-Einführungsliteratur", sub = "Fuck it!!!")
